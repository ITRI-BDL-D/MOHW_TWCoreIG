...
* code.coding[OxygenSatCode].system ^short = "術語系統的識別"
* code.coding[OxygenSatCode].code ^short = "系統定義的語法符號"
* code.coding[PulseOx] only CodingTW
* code.coding[PulseOx] = http://loinc.org#59408-5
* code.coding[PulseOx] ^short = "以脈搏血氧儀測得的動脈血氧飽和度"
* code.coding[PulseOx].system ^short = "術語系統的識別"
* code.coding[PulseOx].code ^short = "系統定義的語法符號"
...
* component[FlowRate].code.coding.system ^short = "術語系統的識別"
* component[FlowRate].code.coding.code ^short = "系統定義的語法符號"
* component[FlowRate].code.coding ^short = "由術語系統定義的代碼"
...
* component[Concentration].code.coding.system ^short = "術語系統的識別"
* component[Concentration].code.coding.code ^short = "系統定義的語法符號"
* component[Concentration].code.coding ^short = "由術語系統定義的代碼"
