...
Alias: $snomed-pregnancy-status-code = https://twcore.mohw.gov.tw/ig/twcore/ValueSet/snomed-pregnancy-status-code
...
* valueCodeableConcept from $snomed-pregnancy-status-code (preferred)
