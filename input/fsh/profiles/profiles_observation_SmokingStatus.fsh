...
Alias: $smoking-status-type-code = https://twcore.mohw.gov.tw/ig/twcore/ValueSet/smoking-status-type-code
Alias: $smoking-status-comprehensive-code = https://twcore.mohw.gov.tw/ig/twcore/ValueSet/smoking-status-comprehensive-code
...
* code MS
* code from $smoking-status-type-code (extensible)
...
* valueQuantity from http://terminology.hl7.org/ValueSet/v3-UnitsOfMeasureCaseSensitive (required)
* valueQuantity ^sliceName = "valueQuantity"
* valueCodeableConcept 0..1 MS
* valueCodeableConcept only CodeableConcept
* valueCodeableConcept from $smoking-status-comprehensive-code (extensible)
